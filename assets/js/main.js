...
var errorName= document.getElementById('error-name');
  ...
  var errorMessage = document.getElementById('error-messagebox');
  ...
  function checkPhone(){
    ...
    if(phone.length == 0 ){
      errorPhone.innerHTML ='Number is required';
      return false;
    }
    if(phone.length !== 10){
      errorPhone.innerHTML = 'The number should be 10 digits';
      return false;
    }
  ...
  var required = 30;
  var left = required - messagetext.length;
  if(left>0){
  ...
  function validateForm(){
    if(!checkName() || !checkEmail() || !checkMessage() || !checkPhone()){
      ...
      errorSubmit.innerHTML = 'Please fill all the coloums'
